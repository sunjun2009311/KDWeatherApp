...
import org.jan.kdweather.R;

public class WeatherDataUtil {
	public static boolean isExit=false;
	public static int parseIcon(String mainTg,String strIcon) {
		if(mainTg!=null){
			System.out.println("iconStr="+strIcon);
			if("0.gif".equals(strIcon)){
				return R.drawable.qin_0;
			}
